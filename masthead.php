...
<header role="banner" id="page-header">
    <div id="skip-link-container">
        <a href="https://discovery.nationalarchives.gov.uk/details/r/154c9e92053e46eaa8cf3096b40c8d8e#page_wrap">Skip to Main Content</a>
    </div>
    <div class="container">
        <div id="holds-logo-and-search" class="row">
            <div id="logo-holder" class="col starts-at-full ends-at-half clr">
                ...
                <a title="Go to The National Archives homepage" href="https://www.nationalarchives.gov.uk/"><img src="./index_files/logo-white.png" srcset="https://discovery.nationalarchives.gov.uk:443/Content/Images/tna-horizontal-white-logo.svg"  alt="The National Archives"></a>
                <form id="mobile-global-search" method="get" action="https://discovery.nationalarchives.gov.uk/results/r">
                    <div id="mobile-search-outer-wrapper" style="display: none;">
                        <div id="mobile-search-wrapper">
                            <input type="text" aria-required="true" required="" name="_q" placeholder="Search our records..." id="mobile-search-field" autocomplete="off">
                            <input type="submit" id="mobileSearchSubmit" value="">
                        </div>
                        <div id="change-destination">
                            <span><input type="radio" data-fieldname="_q" data-placeholder="Search our records..."  data-target="/results/r" id="catalogueSearch" name="searchDestination"  class="mobileSearchDestinationOption" checked=""><label for="catalogueSearch">Search our records</label></span>
                            <span><input type="radio" data-fieldname="_q" data-placeholder="Search our website..." data-target="https://nationalarchives.gov.uk/search/results" id="websiteSearch" name="searchDestination" class="mobileSearchDestinationOption"><label for="websiteSearch">Search our website</label></span>
                        </div>
                    </div>
                </form>
            ...
            <div class="col starts-at-full ends-at-half clr">
                <div id="search-field-wrapper" role="search">
                    <form id="globalSearch" method="get" action="https://discovery.nationalarchives.gov.uk/results/r">
                        <span id="scope-selector" class="interactive-element">&nbsp;</span>
                        <input type="text" aria-required="true" required="" name="_q" id="tnaSearch" placeholder="Search our records..." class="search-field" autocomplete="off">
                        <input type="submit" value="" id="search-button" class="search-button">
                    </form>
                    <ul id="search-options">
                        <li><a aria-label="Change form destination to search the catalogue" role="button" data-fieldname="_q" data-placeholder="Search our records..." data-target="/results/r" class="formDestinationChanger" href="https://discovery.nationalarchives.gov.uk/details/r/154c9e92053e46eaa8cf3096b40c8d8e#">Search our records</a></li>
                        <li><a aria-label="Change form destination to search the website" role="button" data-fieldname="_q" data-placeholder="Search our website..." data-target="https://nationalarchives.gov.uk/search/results" class="formDestinationChanger" href="https://discovery.nationalarchives.gov.uk/details/r/154c9e92053e46eaa8cf3096b40c8d8e#">Search our website</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <!-- NORMAL mega menu -->
    <div class="mega-menu" role="navigation" style="display: none;">
        <section class="row">
            <nav class="col mega-menu-group clr">
                <div>
                    <h3><a data-gtm="mega-menu" href="https://www.nationalarchives.gov.uk/about">About us</a></h3>
                    <ul>
                        <li class="mobileOnly"><a data-gtm="mega-menu" href="https://www.nationalarchives.gov.uk/about/">About us home</a></li>
            ...
            <nav class="col mega-menu-group clr">
                <div>
                    ...
                    <ul>
                        <li class="mobileOnly"><a data-gtm="mega-menu" href="https://www.nationalarchives.gov.uk/education">Education home</a></li>
            ...
            <nav class="col mega-menu-group clr">
                <div>
                    ...
                    <ul>
                        <li class="mobileOnly"><a data-gtm="mega-menu" href="https://www.nationalarchives.gov.uk/help-with-your-research/">Help with your research home</a></li>
            ...
            <nav class="col mega-menu-group clr">
                <div>
                    ...
                    <ul>
                        <li class="mobileOnly"><a data-gtm="mega-menu" href="https://www.nationalarchives.gov.uk/information-management/">Information management home</a></li>
            ...
            <nav class="col mega-menu-group clr">
                <div>
                    ...
                    <ul>
                        <li class="mobileOnly"><a data-gtm="mega-menu" href="https://www.nationalarchives.gov.uk/archives-sector">Archives sector home</a></li>
            ...
            <nav class="col mega-menu-group clr">
                <div>
                    <h3>More...</h3>
                    <ul><li class="mobileOnly"><a data-gtm="mega-menu" href="https://www.nationalarchives.gov.uk/about/">More...</a></li>
                        <li><a data-gtm="mega-menu" href="https://bookshop.nationalarchives.gov.uk/">Bookshop</a></li>
                        ...
                        <li class="imgContent"><a data-gtm="mega-menu" href="https://nationalarchives.gov.uk/coldwar/" title="Discover our 2019 Cold War season"><img src="./index_files/menu-cold-war.jpg" alt="Discover our 2019 Cold War season"></a></li>
                    </ul>
                </div>
            </nav>
        </section>
    ...
    <div id="account-controls-wrapper">
        <div id="account-controls" class="container">
            <ul>
                <li id="signin"><a href="https://discovery.nationalarchives.gov.uk/sign-in">Sign in</a></li>
                <li id="register"><a href="https://discovery.nationalarchives.gov.uk/register">Register</a></li>
                <li id="help"><a href="https://www.nationalarchives.gov.uk/help-with-your-research/discovery-help">Help</a></li>
                <li id="miniBasket"><span class="noItems"><img src="./index_files/basket.png" id="basketIcon" alt="Basket icon">No items</span></li>
            </ul>
        </div>
    </div>
</header>
